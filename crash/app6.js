...
passport = require('passport') , bodyParser = require('body-parser') , favicon = require('serve-favicon') ,	app = express() , pConfig = require('./app_server/config/passport');

require('./app_server/config/db');

require('./app_server/config/users');
																				require('./app_server/config/local')();
